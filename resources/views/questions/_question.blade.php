<div class="form-group question" data-question-id="{{ $question->id or $index }}">
    <fieldset>
        ...
        <input type="text" name="question[{{ $question->id or $index }}][value]" id="question[{{ $question->id or $index }}]" class="form-control question-value" value="{{ $question->value or '' }}" required>
